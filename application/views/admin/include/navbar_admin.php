    ...
    <nav class="navbar">
    	<div class="container-fluid">
    		<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"> <i>Web Monitoring Saung Ngaji</i> <b></b>  </a>
    		</div>
    ...
    <section>
    	...
    	<aside id="leftsidebar" class="sidebar">
    		...
    		<div class="user-info">
    			<div class="image">
    				<img src="<?= base_url(); ?>assets/AdminBsb/images/user.png" width="55" height="55" alt="User" />
    			</div>
    		...
    		<div class="menu">
    			<ul class="list">
    				...
    				<li class="<?php echo ($title == 'testimoni') ? 'active' : ''; ?>">
