            				...
            				<div class="card">
            					<div class="header">
            						<h2 style="font-weight: bold;color: #ad1455;font-size: 22px;">
            							<center>FORM USER ADMIN SMART BIMBEL</center>
            							<br>
            						</h2>
            					</div>
            						...
            						<form action="#" method="post" enctype="multipart/form-data">
            							<div class="row clearfix">
            								...
            								<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            									<div class="form-group">
            										<div class="form-line">
            											<input type="text" class="form-control" placeholder="Isikan Nama " name="nama" required autocomplete="off" />
            										</div>
            									</div>
            								</div>
            							</div>
            							...
            							<div class="row clearfix">
            								...
            								<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            									<div class="form-group">
            										<div class="form-line">
            											<input type="text" class="form-control" placeholder="Isikan Username" name="username" required autocomplete="off" />
            										</div>
            									</div>
            								</div>
            							</div>
            							...
            							<div class="row clearfix">
            								...
            								<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            									<div class="form-group">
            										<div class="form-line">
            											<input type="password" class="form-control" placeholder="Masukan Password" name="password" required autocomplete="off" />
            										</div>
            									</div>
            								</div>
            							</div>
            							...
            							<div class="row clearfix">
            								...
            								<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            									<div class="form-group">
            										<div class="form-line">
            											<input type="password" class="form-control" placeholder="Ulangi Password" name="con_pass" required autocomplete="off" />
            										</div>
            									</div>
            								</div>
            							</div>
