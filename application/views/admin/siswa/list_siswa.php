    											...
    											<td style="text-align: center;vertical-align: middle;">
    												<center>
    													...
    													<?php if ($this->session->userdata('status') == 1) : ?>
    														<a href="<?= base_url('admin/siswa/edit_siswa/') . $siswa['id_user'] ?>" data-toggle="tooltip" data-placement="top" title="Edit"><i style="color: orange;" class="material-icons">description</i></a>&nbsp;

    														 <a href="#" id="btn_posisi3" title="Delete" data-id="<?= $siswa['id_user'] ?>" data-toggle="modal" data-target="#deleteModal"><i style="color:red;" class="material-icons">delete</i></a> 
    													<?php endif; ?>
    												</center>
    											</td>
    										</tr>
