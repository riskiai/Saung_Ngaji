    										...
    										<tr>
    											...
    											<td style="text-align: center;vertical-align: middle;">
    												<center>
    													...
    													<a href="<?= base_url(); ?>admin/kelas/edit_kelas/<?= $kelas['id_kelas']; ?>" data-toggle="tooltip" data-placement="top" title="Edit"><i style="color : orange;" class="material-icons">description</i></a>&nbsp;
    													<a href="#" id="btn_posisi1" title="Delete" data-id="<?= $kelas['id_kelas'] ?>" data-toggle="modal" data-target="#deleteModal"><i style="color:red;" class="material-icons">delete</i></a>
    												</center>
    											</td>
    										</tr>
    									<?php endforeach; ?>
