 		...
 		<div class="row d-flex mb-5 contact-info">
 			<div class="col-md-4">
 				<div class="bg-light align-self-stretch box p-4 text-center">
 					...
 					<p style="color: red;">Pembayaran sebesar Rp.20 Ribu Rupiah. <br>

 						Rincian : Administrasi 0 Rupiah, pembayaran bulan pertama Rp.20 Ribu Rupiah. <br>

 						Untuk Pembayaran bisa via rekening BRI: <i>4521-221-332-111</i> </p>
 				</div>
 			</div>
