		...
		<div class="row">
			...
			<div class="col-8">
				<div style="text-align:center; float:right;display: inline-block; position:relative;">
					<h3 style="margin:0; font-size:20px;">BUKTI PEMBAYARAN SISWA <br>SAUNG NGAJI<br>
		...
		<div class="pernyataan" style="margin-top:30px; margin-bottom:30px;">
			<div class="row">
				<div class="col-12" style="font-size:13px;">
					Catatan : <br>
					- Print bukti pembayaran ini lalu bawa ke tempat SAUNG NGAJI <br>
